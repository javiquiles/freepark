			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					...
					<div class="progress">
						...
						<form:form method="POST" id="form" modelAttribute="reserva" role="form"
								...
								<div class="form-group ${status.error ? 'has-error' : '' }">
									...
									<div class="col-md-10">
										<form:select path="vehiculo.id" cssClass="form-control">
											<form:options items="${usuario.vehiculos}" itemValue="id" itemLabel="patente"/>
										</form:select>
										<c:if test="${status.error}">
											<span class="text-danger">${status.errorMessage}</span>
										</c:if>
							...
							<spring:bind path="estacionamiento.techo">
								<div class="form-group ${status.error ? 'has-error' : '' }">
								<label class="control-label col-md-2" for="estacionamiento.techo">Techo:</label>
									<div class="col-md-10">
										<form:select path="estacionamiento.techo" cssClass="form-control">
							...
							<div class="form-group">
								<div class="col-md-5">
									<button type="submit" class="btn btn-success" data-loading-text="Loading..." id="reservar">Reservar</button>
								</div>
							</div>
						</form:form>
